...
@Service("textPositionalReaderService")
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
@Slf4j
public class TextPositionalReaderService extends AbstractTextReaderService<DataMap, LineNumberReader> {	
	
	@Autowired
	private TextPositionalExtractService extractor;
	
	@Autowired(required = true)
	public TextPositionalReaderService(FileMetaData fileMetaData, Map<String, Map<String, ColumnRelation>> sourceLineColumnRelationMap) {
