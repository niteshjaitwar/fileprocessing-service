...
@Slf4j
public class LargeTextHeaderReaderService extends AbstractTextReaderService<ChunkDataMap, LineNumberReader>{
	
	@Autowired
	private TextHeaderExtractService extractor;
	
	@Autowired(required = true)
	public LargeTextHeaderReaderService(FileMetaData fileMetaData, Map<String, Map<String, ColumnRelation>> sourceLineColumnRelationMap) {
