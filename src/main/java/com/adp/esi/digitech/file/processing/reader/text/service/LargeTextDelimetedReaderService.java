...
@Slf4j
public class LargeTextDelimetedReaderService  extends AbstractTextReaderService<ChunkDataMap, LineNumberReader> {
	
	@Autowired
	private TextDelimetedExtractService extractor;
	
	@Autowired(required = true)
	public LargeTextDelimetedReaderService(FileMetaData fileMetaData, Map<String, Map<String, ColumnRelation>> sourceLineColumnRelationMap) {
